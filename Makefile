...
dist-linux-x64:
	...
	cd ./dists/linux-x64/ && tar -czf  ../vp-linux-x64.tar.gz $(PACK_FILES)
...
dist-macos-x64:
	...
	cd ./dists/macos-x64/ && tar -czf  ../vp-macos-x64.tar.gz $(PACK_FILES)
...
dist-macos-arm64:
	...
	cd ./dists/macos-arm64/ && tar -czf  ../vp-macos-arm64.tar.gz $(PACK_FILES)
